...
In order to support loading of multiple wallets in tioscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tioscoin.cpp.
...
Changes to tioscoin.cpp
----------------------
tioscoin.cpp is the entry point into tioscoin-qt, and as such, will require some minor modifications to provide hooks for
