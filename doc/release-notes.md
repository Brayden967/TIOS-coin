TIOScoin Core version 2.2.1 is now available from:

  <https://github.com/tioscoin-project/tioscoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/tioscoin-project/tioscoin/issues>

Compatibility
==============

TIOScoin Core is extensively tested on multiple operating systems using
...
TIOScoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that TIOScoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/tioscoin-project-translations/).
