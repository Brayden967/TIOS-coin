...
This mechanism has been integrated into Bitcore-Node-TIOS  which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TIOS -Project/insight-api-tioscoin#web-socket-api](https://github.com/TIOS -Project/insight-api-tioscoin#web-socket-api) 
* API: [https://github.com/TIOS -Project/insight-api-tioscoin#swifttx-transactions](https://github.com/TIOS -Project/insight-api-tioscoin#swifttx-transactions) 
...
By default, the TIOS  Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TIOS  Core daemon:
