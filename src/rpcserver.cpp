...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TIOScoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "TIOScoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TIOScoin features */
        {"tioscoin", "masternode", &masternode, true, true, false},
        {"tioscoin", "masternodelist", &masternodelist, true, true, false},
        {"tioscoin", "mnbudget", &mnbudget, true, true, false},
        {"tioscoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"tioscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tioscoin", "mnsync", &mnsync, true, true, false},
        {"tioscoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"tioscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tioscoind, or the -server option to tioscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tioscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41020/\n";
}
