                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TIOScoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TIOScoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tioscoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TIOScoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TIOScoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TIOScoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TIOScoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TIOScoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a TIOScoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TIOScoin Core help message to get a list with possible TIOScoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TIOScoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TIOScoin network", "", count));
}
...
{
    QString strTitle = tr("TIOScoin Core"); // default title
