...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TIOScoin Core"),
     ...
     * override -datadir in the tioscoin.conf file in the default data directory
     * (to be consistent with tioscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
