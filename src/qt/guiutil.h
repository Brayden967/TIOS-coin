...
/** Utility functions used by the TIOScoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TIOScoin addresses in monospace font
...
// Parse "tioscoin:" URI into recipient object, return true on successful parsing
