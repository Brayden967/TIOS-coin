...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TIOScoin Core tioscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tioscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tioscoin transaction") + "\n" +
                               "  tioscoin-tx [options] -create [commands]   " + _("Create hex-encoded tioscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tioscoin transaction
