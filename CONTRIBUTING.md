Contributing to TIOScoin Core
============================

The TIOScoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TIOScoin Core project, and is not to be
confused with overall TIOScoin Network Protocol consensus changes.

Whether a pull request is merged into TIOScoin Core rests with the project merge
...
Patches that change TIOScoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TIOScoin consensus, it must have been
...
The project leader is the release manager for each TIOScoin Core release.
