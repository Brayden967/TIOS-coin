...
RESOURCES += src/qt/tioscoin.qrc src/qt/tioscoin_locale.qrc

TRANSLATIONS += src/qt/locale/tioscoin_bg.ts \
                src/qt/locale/tioscoin_de.ts \
                src/qt/locale/tioscoin_en.ts \
                src/qt/locale/tioscoin_es.ts \
                src/qt/locale/tioscoin_fi.ts \
                src/qt/locale/tioscoin_fr.ts \
                src/qt/locale/tioscoin_it.ts \
                src/qt/locale/tioscoin_ja.ts \
                src/qt/locale/tioscoin_pl.ts \
                src/qt/locale/tioscoin_pt.ts \
                src/qt/locale/tioscoin_ru.ts \
                src/qt/locale/tioscoin_sk.ts \
                src/qt/locale/tioscoin_sv.ts \
                src/qt/locale/tioscoin_vi.ts \
                src/qt/locale/tioscoin_zh_CN.ts \
                src/qt/locale/tioscoin_zh_TW.ts
